...
# ertData_t1 = pb.load("SCH2010-07-21_u_i.txt")
# ertData_t2 = pb.load("SCH2010-08-22_u_i.txt")

# print("Number of electrodes t1:", ertData_t1.sensorCount())
# print("Number of electrodes t2:", ertData_t2.sensorCount())
# print(ertData_t1, ertData_t2)

# rstData_t1 = pg.DataContainer("SCH2010-07-21_tt.txt", "s g")
# rstData_t2 = pg.DataContainer("SCH2010-08-22_tt.txt", "s g")
# print("Number of shot/receivers t1:", rstData_t1.sensorCount())
# print("Number of shot/receivers t2:", rstData_t2.sensorCount())

# maxrst = pg.max(pg.x(rstData_t1.sensors()))
# maxrst = pg.max(pg.x(rstData_t2.sensors()))
...
for timestep in range(1,ntimes+1):
    ertData.append(pb.load("ert_t%s.data" % timestep))
    ...
    ertData[timestep-1].removeSensorIdx(idx)
    ...
    rstData[timestep-1].markInvalid((offset < 5) & (va > 800))
    #
