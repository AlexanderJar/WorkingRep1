...
for timestep in range(1,ntimes+1):
    ...
    for cell in mesh.cells():
        if cell.center().y() > ALT_thickness:
            if cell.center().x() <= 75:
                cell.setMarker(0)
            elif cell.center().x() > 75:
                cell.setMarker(1)
        elif cell.center().y() <= ALT_thickness:
            if cell.center().x() <= 75:
                cell.setMarker(2)
            elif cell.center().x() > 75:
                cell.setMarker(3)
    ...
    philayers = np.array([0.3, 0.2, 0.3, 0.2])
    frlayers = 1 - philayers
    
    if timestep == 1:
        fwlayers = np.array([0.05, 0.03, 0.01, 0.01])
        filayers = np.array([0.0, 0.0, 0.24, 0.16])
    if timestep == 2:
        fwlayers = np.array([0.25, 0.17, 0.01, 0.01])
        filayers = np.array([0.0, 0.0, 0.24, 0.16])
    if timestep == 3:
        fwlayers = np.array([0.01, 0.01, 0.01, 0.01])
        filayers = np.array([0.24, 0.16, 0.24, 0.16])
