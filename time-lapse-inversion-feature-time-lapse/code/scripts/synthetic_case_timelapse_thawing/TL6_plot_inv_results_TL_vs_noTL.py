...
for timestep in range(1,ntimes+1):
    ...
    est = np.load("conventional_TL_Fig2_t%s.npz" % timestep)
    joint1 = np.load("TL_joint_inversion_lam10.0_zW1.0_delta0_eps0_it10_noscale.npz")
    joint2 = np.load("TL_joint_inversion_lam10.0_zW1.0_delta150_eps0_it10.npz")
    ...
    fig.savefig("TL_joint_inversion_lam10.0_zW1.0_delta0vs150_eps0_it10.pdf" % timestep, dpi=500, bbox_inches="tight", pad_inches=0.0)