...
ertScheme = pg.DataContainerERT("data_filtered/ert_filtered_t1.data")
ertScheme2 = pg.DataContainerERT("data_filtered/ert_filtered_t2.data")
ertScheme3 = pg.DataContainerERT("data_filtered/ert_filtered_t3.data")
...
ttData = pg.DataContainer("data_filtered/rst_filtered_t1.data", "s g")
ttData2 = pg.DataContainer("data_filtered/rst_filtered_t2.data", "s g")
ttData3 = pg.DataContainer("data_filtered/rst_filtered_t3.data", "s g")
