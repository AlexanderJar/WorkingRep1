...
import pygimli.physics.ert as ertMan     #added by Alex 25
...
try:     #added by Alex 25
    shutil.rmtree('Output_file/ji_inv_Lcurve')     #added by Alex 25
except:    #added by Alex 25
    print('Create JI inv l-curve file')     #added by Alex 25
os.mkdir('Output_file/ji_inv_Lcurve')     #added by Alex 25
...
ttData = pg.DataContainer("Output_file/data_filtered/rst_filtered_t1.data", "s g")
ttData2 = pg.DataContainer("Output_file/data_filtered/rst_filtered_t2.data", "s g")
ttData3 = pg.DataContainer("Output_file/data_filtered/rst_filtered_t3.data", "s g")
...
for lam in lams:
    ...
    for delta in deltas:
        ...
        np.savez("Output_file/ji_inv_Lcurve/TL_joint_inversion_SCH_Lcurve_lam%s_zW%s_delta%s_gam%s_eps%s_it%s.npz" % (lam,zW,delta,gam,eps,maxIter), vel=np.array(velest),
...
np.save("Output_file/ji_inv_Lcurve/chi.npy",chis,allow_pickle=True)
np.save("Output_file/ji_inv_Lcurve/rms.npy",rmss,allow_pickle=True)
np.save("Output_file/ji_inv_Lcurve/deltas_Lcurve.npy",deltas,allow_pickle=True)
np.save("Output_file/ji_inv_Lcurve/lambdas.npy",lams,allow_pickle=True)
