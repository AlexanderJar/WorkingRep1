...
for timestep in range(1,ntimes+1):
    ...
    if timelapse == True:
        joint = np.load("TL_joint_inversion_%s_lam1.0_gam0_zw1_coarse_new9_delta10_fr_it4.npz" % scenario)
    elif timelapse == False:
        joint = np.load("TL_joint_inversion_%s_t%s_coarse_new8_delta10_fr_it8.npz" % (scenario, timestep))
    ...
    cmaps = ["viridis", "Spectral_r", "Blues", "Purples", "Greens", "Oranges", "bwr"]
    ...
    if timelapse == True:
        fig.savefig("TL_%s_t%s_two_columns_with_sum_lam1.0_gam0_zw1_coarse_new9_delta10_fr_it4.pdf" % (scenario, timestep), dpi=500, bbox_inches="tight",
                    pad_inches=0.0)
    elif timelapse == False:
        fig.savefig("%s_t%s_two_columns_with_sum_coarse_new8_delta10_fr_it8.pdf" % (scenario, timestep), dpi=500, bbox_inches="tight",
                    pad_inches=0.0)
