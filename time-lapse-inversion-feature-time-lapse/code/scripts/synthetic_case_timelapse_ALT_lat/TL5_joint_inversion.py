...
JM = JointMod(meshRST, ert, rst, fpm, ntimes=ntimes, fix_poro=fix_poro, zWeight=1.)
...
if timelapse == True:
    np.savez("TL_joint_inversion_%s_lam%s_gam%s_zw1_coarse_new9_delta10_fr_it4.npz" % (scenario,lam,gam), vel=np.array(velest),
