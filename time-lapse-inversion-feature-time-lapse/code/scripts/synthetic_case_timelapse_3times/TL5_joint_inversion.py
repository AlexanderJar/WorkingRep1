...
ertScheme3 = pg.DataContainerERT("erttrue_t2.dat")
...
ttData3 = pg.DataContainer("tttrue_t2.dat", "s g")
...
if timelapse == True:
    np.savez("TL_joint_inversion_%s.npz" % scenario, vel=np.array(velest),
