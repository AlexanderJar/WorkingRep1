...
for timestep in range(1,ntimes+1):
    ...
    joint1 = np.load("TL_joint_inversion_lam10.0_zW1.0_delta0_eps0_it10.npz")
    ...
    fig.savefig("TL_t%s_lam10_zW1.0_delta0vs150_eps0_it10.pdf" % timestep, dpi=500, bbox_inches="tight", pad_inches=0.0)
