...
for timestep in range(1,ntimes+1):
    ...
    if timestep == 1:
        fwlayers = np.array([0.3, 0.1, 0.02, 0.1, 0.02])
        filayers = np.array([0.0, 0.18, 0.28, 0.18, 0.18])
    if timestep == 2:
        fwlayers = np.array([0.3, 0.1, 0.1, 0.1, 0.02])
        filayers = np.array([0.0, 0.18, 0.18, 0.18, 0.18])
