...
for timestep in range(1,ntimes+1):
    ...
    philayers = np.array([0.4, 0.4, 0.2, 0.2])
    frlayers = 1 - philayers
    
    if timestep == 1:
        fwlayers = np.array([0.3, 0.22, 0.02, 0.02])
        filayers = np.array([0.0, 0.12, 0.18, 0.18])
    if timestep == 2:
        fwlayers = np.array([0.3, 0.32, 0.02, 0.02])
        filayers = np.array([0.0, 0.0, 0.18, 0.18])
    if timestep == 3:
        fwlayers = np.array([0.3, 0.32, 0.15, 0.02])
        filayers = np.array([0.0, 0.0, 0.0, 0.18])
