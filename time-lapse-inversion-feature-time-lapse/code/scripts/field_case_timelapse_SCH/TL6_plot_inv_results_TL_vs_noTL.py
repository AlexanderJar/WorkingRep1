...
for timestep in range(1,ntimes+1):
    ...
    # Load data
    joint = np.load("TL_joint_inversion_SCH_lam10.0_zW0.25_delta100.0_gam0_eps1_it10_new.npz")
    joint2 = np.load("TL_joint_inversion_SCH_lam10.0_zW0.25_delta100.0_gam0_eps1_it10_new_atc.npz")
    ...
    fig.savefig("test_t%s_dwia_atc.pdf" % timestep, dpi=500, bbox_inches="tight",
                pad_inches=0.0)
