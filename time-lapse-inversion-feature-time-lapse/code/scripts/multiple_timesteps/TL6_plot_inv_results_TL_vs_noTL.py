...
for timestep in range(1,ntimes+1):
    ...
    joint1 = np.load("TL_joint_inversion_Fig2_lam10.0_gam0_zW1.0_delta0_it10.npz")
    joint2 = np.load("TL_joint_inversion_Fig2_lam10.0_gam0_zW1.0_delta100_it10.npz")
    ...
    fig.savefig("TL_t%s_lam10.0_gam0_zW1.0_delta0vs100.pdf" % timestep, dpi=500, bbox_inches="tight", pad_inches=0.0)
